    ...
    begin:
        ...
        else
        {
            ...
            startQuiz:
                ...
                Console.WriteLine($"1. {data[i, 1]}");
                Console.WriteLine($"2. {data[i, 2]}");
                Console.WriteLine($"3. {data[i, 3]}");
                Console.WriteLine($"4. {data[i, 4]}");

                bool isNumber = int.TryParse(Console.ReadLine(), out input);

                if (isNumber && input >= 1 && input <= 4)
                {
                    int correctAnswer = int.Parse(data[i, 5]);
